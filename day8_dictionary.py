...
# Each of the  subsequent lines describes an entry in the form of  space-separated
# values on a single line. The first value is a friend's name, and the second value is
# an -digit phone number.
# After the  lines of phone book entries, there are an unknown number of lines of
# queries. Each line (query) contains a  to look up, and you must continue reading
# lines until there is no more input.
